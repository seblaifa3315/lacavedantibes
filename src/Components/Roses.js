...
class Roses extends Component {
    ...
    render() {
        const provence = this.state.provence
            ? this.props.roses.roses.filter(
                  (rose) => rose.region === "Provence Rosé"
              )
            : this.props.roses.roses.filter(
                (rose) => rose.region === "Provence Rosé"
            );
        ...
        const roses = all.map((rose) => {
            return (
                <div key={rose.id} className="row myRow">
                    <RenderCard item={rose} postCart={this.props.postCart} />
                </div>
            );
        });
        ...
        return (
            <div className="bodyBackground">
                ...
                <Breadcrumb>
                    ...
                    <BreadcrumbItem active>Rosés</BreadcrumbItem>
                </Breadcrumb>
                <div className="text-center header">
                    <h1 className="display-4">Our Rosés</h1>
...
export default connect(mapStateToProps, mapDispatchToProps)(Roses);
