                    ...
                    <div className="col-sm-8 col-md-10">
                        <div className="row">
                            <div className="col-7 myCol2">
                                ...
                                <p>
                                    <span>{this.props.item.cepage}</span>
                                </p>
                            </div>
...
class Oils extends Component {
    ...
    render() {
        const all = this.props.oils.oils;
        ...
        const oils = all.map((oil) => {
            return (
                <div key={oil.id} className="row myRow">
                    <RenderCard item={oil} postCart={this.props.postCart} />
                </div>
            );
        });
        ...
        return (
            <div className="bodyBackground">
                ...
                <Breadcrumb>
                    ...
                    <BreadcrumbItem active>Oils</BreadcrumbItem>
                </Breadcrumb>
                <div className="text-center header">
                    <h1 className="display-4">Our Oils</h1>
