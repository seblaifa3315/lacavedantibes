...
class Digestives extends Component {
    constructor(props) {
        super(props);
        this.state = {
            sortBy: ""
    ...
    render() {
        const all = this.props.digestives.digestives;
        ...
        const digestives = all.map((digestif) => {
            return (
                <div key={digestif.id} className="row myRow">
                    <RenderCard item={digestif} postCart={this.props.postCart} />
                </div>
            );
        });
        ...
        return (
            <div className="bodyBackground">
                ...
                <Breadcrumb>
                    ...
                    <BreadcrumbItem active>Digestives</BreadcrumbItem>
                </Breadcrumb>
                <div className="text-center header">
                    <h1 className="display-4">Our Digestives</h1>
...
export default connect(mapStateToProps, mapDispatchToProps)(Digestives);
